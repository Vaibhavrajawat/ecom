    ...
    <div className="w-full min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="absolute inset-0 -z-10 pointer-events-none">
          <div className="absolute top-0 right-0 w-[400px] h-[300px] bg-gradient-to-br from-blue-500/30 to-transparent rounded-full blur-2xl" />
          <div className="absolute bottom-0 left-0 w-[400px] h-[300px] bg-gradient-to-br from-purple-500/30 to-transparent rounded-full blur-2xl" />
        </div>
        ...
        <div className="bg-black/30 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">
              Join PrimeSpot to access exclusive digital products
            </p>
          </div>
